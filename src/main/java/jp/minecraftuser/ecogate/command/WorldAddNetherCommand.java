 ...
 * @author ecolight
 */
public class WorldAddNetherCommand extends CommandFrame {
     ...
     * @param name_ コマンド名
     */
    public WorldAddNetherCommand(PluginFrame plg_, String name_) {
        super(plg_, name_);
    ...
    public String getPermissionString() {
        return "ecogate.world.add.nether";
    }
    ...
    public boolean worker(CommandSender sender, String[] args) {
        ...
        World w = worlds.addNetherWorld(args[0]);
