 ...
 * @author ecolight
 */
public class WorldAddTheEndCommand extends CommandFrame {
     ...
     * @param name_ コマンド名
     */
    public WorldAddTheEndCommand(PluginFrame plg_, String name_) {
        super(plg_, name_);
    ...
    public boolean worker(CommandSender sender, String[] args) {
        ...
        World w = worlds.addEndWorld(args[0]);
