 ...
 * @author ecolight
 */
public class WorldAddNormalCommand extends CommandFrame {
     ...
     * @param name_ コマンド名
     */
    public WorldAddNormalCommand(PluginFrame plg_, String name_) {
        super(plg_, name_);
    ...
    public String getPermissionString() {
        return "ecogate.world.add.normal";
    }
    ...
    public boolean worker(CommandSender sender, String[] args) {
        ...
        World w = worlds.addNormalWorld(args[0]);
