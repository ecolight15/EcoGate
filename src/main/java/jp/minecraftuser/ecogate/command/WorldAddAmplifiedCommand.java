...
/**
 * アンプリファイドワールド追加コマンドクラス
 * @author ecolight
 */
public class WorldAddAmplifiedCommand extends CommandFrame {
     ...
     * @param name_ コマンド名
     */
    public WorldAddAmplifiedCommand(PluginFrame plg_, String name_) {
        super(plg_, name_);
    ...
    public String getPermissionString() {
        return "ecogate.world.add.amplified";
    }
    ...
    public boolean worker(CommandSender sender, String[] args) {
        ...
        World w = worlds.addAmplifiedWorld(args[0]);
