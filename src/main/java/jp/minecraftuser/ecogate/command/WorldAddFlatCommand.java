...
/**
 * スーパーフラットワールド追加コマンドクラス
 * @author ecolight
 */
public class WorldAddFlatCommand extends CommandFrame {
     ...
     * @param name_ コマンド名
     */
    public WorldAddFlatCommand(PluginFrame plg_, String name_) {
        super(plg_, name_);
    ...
    public boolean worker(CommandSender sender, String[] args) {
        ...
        World w = worlds.addFlatWorld(args[0]);
